...
Download our processed Mobile ALOHA Dataset from [here]([https://mobile-aloha.github.io](https://huggingface.co/datasets/robotics-diffusion-transformer/aloha-data)) to `data/datasets/aloha`, then run:
